...
if(!empty($_SESSION['userID'])) {
    ...
    if($control == 'activities') {
        ...
        $stmt = showActivity($gender, $Health_status, $physical_state, 2);
        ?>
        <div class="container">
                    ...
                    <form action="?control=filterActivities" method="POST" class="filter-form">
                        ...
                        <div class="input-field">
                            ...
                            <div class="radios">
                                ...
                                <div class="radio">
                                    <input type="radio" name="severity_level" value="2">M
                                </div>
                                <div class="radio">
                                    <input type="radio" name="severity_level" value="3">E
                                </div>
                            </div>
                        </div>
                        <div class="input-field">
                            ...
                            <div class="radios">
                                <div class="radio">
                                    <input type="radio" name="activityschedule_Health_status" value="1">H
                                </div>
                                <div class="radio">
                                    <input type="radio" name="activityschedule_Health_status" value="2">M
                                </div>
                                <div class="radio">
                                    <input type="radio" name="activityschedule_Health_status" value="3">E
                                </div>
                            </div>
                            <?php
                        ...
                        <div class="input-field">
                            ...
                            <div class="radios">
                                <div class="radio">
                                    <input type="radio" name="activityschedule_physical_state" value="1">H
                                </div>
                                <div class="radio">
                                    <input type="radio" name="activityschedule_physical_state" value="2">M
                                </div>
                                <div class="radio">
                                    <input type="radio" name="activityschedule_physical_state" value="3">E
                                </div>
                            </div>
                            <?php 
