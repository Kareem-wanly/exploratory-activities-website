    ...
    if($control == 'active') {
        $stmt = viewActivity_userID($_SESSION['userID'], 1);
            ...
            <div class="container">
                ...
                <a href="?control=inActive" class="btn btn-primary">active activities</a>
                <?php 
                if ($stmt->rowCount() > 0) {
                    ?>
        ...
        $stmt = viewActivity_userID($_SESSION['userID'], 2);
            ...
            <div class="container">
                ...
                <a href="?control=active" class="btn btn-primary">inactive activities</a>
                <?php 
                if ($stmt->rowCount() > 0) {
                    ?>
                    <div class="card-container">
        ...
        <div class="container">
            ...
            <div class="main-title">
                ...
                <a href="?control=unapproved-registration&activityID=<?php echo $activityID ?>" class="btn btn-warning">all registration</a>
                <a href="?control=unapproved-posts&activityID=<?php echo $activityID ?>" class="btn btn-info">all posts</a>
                <a href="?control=unapprovedRating&activityID=<?php echo $activityID ?>" class="btn btn-secondary">all ratings</a>
